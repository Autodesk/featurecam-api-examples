...
namespace FeatureCAMToCAMplete
{
    ...
    {
        public static string prog_name = "FeatureCAM to CAMplete";
        ...
        public static string part_fpath = "";
        public static string part_solid_name;

        public static bool
                is_export_part = false, is_export_part_now = false, is_use_part_file = false;
