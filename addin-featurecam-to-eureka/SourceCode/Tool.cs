...
namespace FeatureCAMToEUREKA
{
    ...
    class Tool
    {
        ...
        public static string AllToolsToString(FeatureCAM.FMTool tool, List<string> partline_features)
        {
            List<GeomSegment> cutter = null, shank = null;
            string tool_desc = "";
            int tool_special_type_id = -1;
            string tool_name = "";
            int pot_number = -1; //is this spot in the holder 
            int tool_num = -1;
            double rad_comp = -1; //DiamC/number of the radius compensation
            double comp_1st_len = -1; //LenC/Number of the 1st length compensation
            double comp_2nd_len = -1; //LenC2/Number of the 2nd length compensation 
            ...
            try
            {
                ...
                switch (tool.ToolGroup)
                {
                    case tagFMToolGroup.eTG_EndMill:
                        EndMillToGeometry((FMEndMill)tool, ref tool_diam, ref tool_len, ref cutter, ref shank);
                        break;
                    case tagFMToolGroup.eTG_ChamferMill:
                        ChamferMillToGeometry((FMChamferMill)tool, ref tool_diam, ref tool_len, ref cutter, ref shank);
                        break;
                    case tagFMToolGroup.eTG_CounterBore:
                        CounterBoreToGeometry((FMCounterBore)tool, ref tool_diam, ref tool_len, ref cutter, ref shank);
                        break;
                    case tagFMToolGroup.eTG_CounterSink:
                        CounterSinkToGeometry((FMCounterSink)tool, ref tool_diam, ref tool_len, ref cutter, ref shank);
                        break;
                    case tagFMToolGroup.eTG_FaceMill:
                        FaceMillToGeometry((FMFaceMill)tool, ref tool_diam, ref tool_len, ref cutter, ref shank);
                        break;
                    case tagFMToolGroup.eTG_PlungeRough:
                        PlungeMillToGeometry((FMPlungeMill)tool, ref tool_diam, ref tool_len, ref cutter, ref shank);
                        break;
                    case tagFMToolGroup.eTG_Ream:
                        ReamToGeometry((FMReam)tool, ref tool_diam, ref tool_len, ref cutter, ref shank);
                        break;
                    case tagFMToolGroup.eTG_RoundingMill:
                        RoundingMillToGeometry((FMRoundingMill)tool, ref tool_diam, ref tool_len, ref cutter, ref shank);
                        break;
                    case tagFMToolGroup.eTG_SideMill:
                        SideMillToGeometry((FMSideMill)tool, ref tool_diam, ref tool_len, ref cutter, ref shank);
                        break;
                    case tagFMToolGroup.eTG_SpotDrill:
                        SpotDrillToGeometry((FMSpotDrill)tool, ref tool_diam, ref tool_len, ref cutter, ref shank);
                        break;
                    case tagFMToolGroup.eTG_Tap:
                        TapToGeometry((FMTap)tool, ref tool_diam, ref tool_len, ref cutter, ref shank);
                        break;
                    ...
                    case tagFMToolGroup.eTG_TwistDrill:
                        TwistDrillToGeometry((FMTwistDrill)tool, ref tool_diam, ref tool_len, ref cutter, ref shank);
                        break;
                    case tagFMToolGroup.eTG_BoringBar:
                        BoringBarToGeometry((FMBoringBar)tool, ref tool_diam, ref tool_len, ref cutter, ref shank);
                        break;
                    default:
                ...
                tool_desc = "BEGIN_TOOL" + Lib.EOL +
                                   ...
                                   Lib.tab + "|UNITS|" +
                                                (tool.Metric ? "MM" : "INCH") + "|" + Lib.EOL +
                                   Lib.tab + "|GAUGE|" + //lenth under spindle
                                                (tool.ExposedLength + tool.Holder.Length) + "|" +
                                                "0" + "|" + Lib.EOL +
                                   Lib.tab + "<CUTTER TYPE=\"CUSTOM_REVOLUTED\">" + Lib.EOL +
                                                ToolProfileToString(cutter, 2, tool.Metric) + Lib.EOL +
