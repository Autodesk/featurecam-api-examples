...
namespace FeatureCAMToEUREKA
{
    public static class Lib
    {
        ...
        public static string pt_0_str = "0,0";
        public static string ccw = "CCW", cw = "CW";
        public static string line_no_cut = "|LINE|NOCUT|";
        public static string line_cut = "|LINE|CUT|";
        public static string arc_no_cut = "|ARC|NOCUT|";
        public static string arc_cut = "|ARC|CUT|";
